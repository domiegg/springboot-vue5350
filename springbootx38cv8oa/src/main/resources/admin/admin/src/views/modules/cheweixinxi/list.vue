				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('cheweixinxi','车位预约')" @click="cheweiyuyueCrossAddOrUpdateHandler(scope.row,'cross','','','cheweizhuangtai','已停放','已停放,未停放'.split(',')[0])" type="success">
