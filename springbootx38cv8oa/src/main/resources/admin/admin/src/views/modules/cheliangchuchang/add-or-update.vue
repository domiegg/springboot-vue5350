		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'" label="停车时长" prop="tingcheshizhang">
					<el-input v-model="tingcheshizhang" placeholder="停车时长" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.tingcheshizhang" label="停车时长" prop="tingcheshizhang">
					<el-input v-model="ruleForm.tingcheshizhang" placeholder="停车时长" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'" label="停车费用" prop="tingchefeiyong">
					<el-input v-model="tingchefeiyong" placeholder="停车费用" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.tingchefeiyong" label="停车费用" prop="tingchefeiyong">
