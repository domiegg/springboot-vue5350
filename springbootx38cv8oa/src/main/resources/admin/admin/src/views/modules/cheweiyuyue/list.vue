				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('cheweiyuyue','出场')" @click="cheliangchuchangCrossAddOrUpdateHandler(scope.row,'cross','','','cheliangzhuangtai','已出场','已出场,未出场'.split(',')[0])" type="success">
...
import cheliangchuchangCrossAddOrUpdate from "../cheliangchuchang/add-or-update";
    ...
    init () {
        this.sfshOptions = "是,否,待审核".split(',');
          this.cheliangzhuangtaiOptions = "已出场,未出场".split(',')
    },
    search() {
      this.pageIndex = 1;
      this.getDataList();
